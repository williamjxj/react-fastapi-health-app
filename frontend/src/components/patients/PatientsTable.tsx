              ...
              search
                ...
                : () => {
                    ...
                    const registrationSection = document.querySelector(
                      '[aria-labelledby="patient-registration-heading"]'
                    )
                    ...
                    <tr className="border-b bg-muted/50">
                      <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">
                        <button
                          ...
                          className="flex items-center hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                          aria-label={`Sort by Patient ID ${sortBy === 'patientID' && sortOrder === 'asc' ? 'descending' : 'ascending'}`}
                        >
                          Patient ID
                      ...
                      <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">
                        <button
                          ...
                          className="flex items-center hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                          aria-label={`Sort by Age ${sortBy === 'age' && sortOrder === 'asc' ? 'descending' : 'ascending'}`}
                        >
                          Age
                          <SortIcon field="age" />
                        </button>
