...
describe('PatientManagementPage Responsive Design - 1280px', () => {
  it('should maintain two-column layout at 1280px', () => {
    const { container } = render(<PatientManagementPage />)
    const grid = container.querySelector('[class*="grid"]')
    
    // Should maintain two-column layout
    expect(grid).toHaveClass('lg:grid-cols-2')
  })

  it('should have appropriate max-width container', () => {
    const { container } = render(<PatientManagementPage />)
